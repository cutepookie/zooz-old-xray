...
clear
echo -e "\e[36m\033[0m"
echo -e " \E[0;36m                 DNS CHANGER                \E[0m"
echo -e "\e[36m\033[0m
\033[1;37mDNS Changer By cutepookie\033[0m
...
echo -e "
 [\033 1 \033[0m]  Temporary DNS
 [\033 2 \033[0m]  Permanent DNS
 [\033 3 \033[0m]  Reset DNS To Default
 [\033 4 \033[0m]  Back To Main Menu"
echo ""
